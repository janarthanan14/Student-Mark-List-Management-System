...
<html lang="en">
	<head>
		<title>Admin | Manage Details</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | Manage Details</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Details</span></h5>
...
$sql=mysqli_query($con,"select * from tblmanage");
$cnt=1;
...
<a href="manage-details.php?viewid=<?php echo $row['ID'];?>"><i class="fa fa-eye"></i></a>
												</div>
