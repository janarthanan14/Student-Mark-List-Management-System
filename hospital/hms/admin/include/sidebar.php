				...
				<li>
								...
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Bill generation </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="fill-details.php">
											<span class="title"> Fill details</details> </span>
										</a>
									</li>
									...
									<li>
										<a href="manage-details.php">
											<span class="title"> Manage details</details> </span>
										</a>
									</li>
