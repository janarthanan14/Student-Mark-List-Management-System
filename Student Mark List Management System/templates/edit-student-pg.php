                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-24">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-select" aria-label="Default select example" name="course" value="<?php echo $editData['course'] ?? ''; ?>">
                                <option disabled selected value="default"><?php echo $editData['course'] ?? ''; ?></option>
                                <?php
